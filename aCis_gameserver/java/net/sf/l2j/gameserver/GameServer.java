...
import net.sf.l2j.ProjectBanner;
...
import net.sf.l2j.gameserver.vip.VIPReset;
...
public class GameServer
{
	...
	public GameServer() throws Exception
	{
	    ...
	    if (Config.CLEAR_VIP_EVENT_ENABLED) {
	        VIPReset.getInstance().StartNextEventTime();
	      } else {
	    	  LOGGER.info("[VIP Reset]: desativado...");
	      }
		...
		TvTManager.getInstance();
 	    ...
 	    {
 	    	ThreadPool.schedule(Tournament.getInstance(), 5000L);
	    	ThreadPool.schedule(UnrealTournament.getInstance(), 5000L);
	    	ThreadPool.schedule(XtremeTournament.getInstance(), 5000L);
		...
		StringUtil.printSection("Protection Hwid");
		Hwid.Init();
