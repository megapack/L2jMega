...
import net.sf.l2j.gameserver.model.zone.type.CustomZone;
...
public class MapRegionData extends XMLDocument
{
	...
	public Location getLocationToTeleport(Creature creature, TeleportType teleportType)
	{
		...
		final CustomZone pvp = ZoneManager.getInstance().getZone(player, CustomZone.class);
	      if (pvp != null) 
	        return pvp.getSpawnLoc();
