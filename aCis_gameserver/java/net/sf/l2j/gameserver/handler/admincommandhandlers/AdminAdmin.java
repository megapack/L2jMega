...
public class AdminAdmin implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(String command, Player activeChar)
	{
		if (command.startsWith("admin_admin"))
			...
			activeChar.sendMessage((AdminData.showOrHideGm(activeChar)) ? "Removed from GMList." : "Registered into GMList.");
			...
			try
			{
				do
				{
					...
					else if (type.startsWith("damage"))
					{
						...
						activeChar.sendMessage("damage have been reloaded.");
					}
					else if (type.startsWith("damageoly"))
					{
						OlympiadDamageManager.loadConfig();
						activeChar.sendMessage("damage in oly have been reloaded.");
					}
					else
					{
