...
{
	protected static final Logger _log = Logger.getLogger(HeroEternal.class.getName());
	...
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
	{
		...
		else
		{
			...
			updateDatabase(activeChar, 0 * 24L * 60L * 60L * 1000L);
			...
			playable.destroyItem("Consume", item.getObjectId(), 1, null, false);
		      ...
		      DonateLog.auditGMAction(activeChar.getObjectId(), activeChar.getName(), "Coin - Hero Eternal", ip);
		}
	}
